...
// Use a great circle to calculate total difference: **look up AngularDistanceTo
...
// Check if flipping (add 12h to RA) is closer overall
...
// Default values for RArot and DErot.
    ...
    errOut->setText(QString("%1 arcsec: RA %2 %3, DE %4").arg(
